...
function AppLayout() {
  ...
  const { websiteId, setWebsiteId, strategy, setStrategy, setScanForWebsite } = useSiteStore()
    ...
    <div className="flex flex-col h-screen overflow-hidden bg-gray-50">
      ...
      <header className="h-16 bg-white border-b border-zinc-200 flex items-center pl-6 pr-5 z-20 shrink-0 w-full gap-0">
          ...
          <div className="flex items-stretch rounded-sm overflow-hidden">
            ...
            <button
              type="button"
              className="px-2 py-2.5 bg-blue-600 hover:bg-blue-700 text-white transition-colors flex items-center"
            >
          ...
          <Link to="/scan-history" className="hidden sm:flex w-9 h-9 items-center justify-center text-gray-500 hover:text-gray-700 rounded-full hover:bg-gray-50 transition-colors mr-3">
          ...
          <div ref={userRef} className="relative">
            <button
              ...
              className="w-9 h-9 rounded-full bg-neutral-700 flex items-center justify-center shrink-0 hover:bg-neutral-800 transition-colors"
            >
